...
class Pagination
{
     ...
     * @return
     */
    public function __construct($total, $currentPage, $limit = 10, $index = 'page')
    {
    ...
    public function get()
    {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            ...
            if ($page == $this->current_page) {
                $links .= '<li class="num-active"><a href="#">' . $page . '</a></li>';
            } else {
        ...
        if (!is_null($links)) {
            ...
            if ($this->current_page > 1)
                ...
                $links = $this->generateHtml(1, '&lt; Туда') . $links;

            # Если текущая страница не первая
            if ($this->current_page < $this->amount)
                # Создаём ссылку "На последнюю"
                $links .= $this->generateHtml($this->amount, 'Сюда &gt;');
        }
